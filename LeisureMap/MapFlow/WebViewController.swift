...
//        WebView.load(request)
        ...
        let congfigration = WKWebViewConfiguration()
        congfigration.preferences = preferences
        congfigration.userContentController = contentController
        
        
        WebView = WKWebView(frame: view.bounds, configuration: congfigration)
    ...
    func webView(_ webView: WKWebView, runJavaScriptTextInputPanelWithPrompt prompt: String, defaultText: String?, initiatedByFrame frame: WKFrameInfo, completionHandler: @escaping (String?) -> Void) {
        ...
        alert.addTextField(configurationHandler: {
            (textTextFile:UITextField)
            in
            
            textTextFile.text = defaultText
            txt = textTextFile
